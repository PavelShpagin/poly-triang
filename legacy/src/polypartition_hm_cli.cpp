...
//
// This is the well-known Hertel–Mehlhorn heuristic (often used for convex
// decomposition). We use it as the "Hertel" baseline as requested.
//
// Input:  .poly (n then n lines x y), simple polygon without holes.
// Output: .tri (repo format) and one stdout line:
