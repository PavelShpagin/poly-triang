...
create_paper_example = paper_example
...
create_star_polygon = star_polygon
...
# Alias for backward compatibility
create_comb_polygon = comb_polygon


def nested_polygon() -> List[Tuple[float, float]]:
    """Create a nested/spiral-like polygon."""
    return [
        (0, 0), (10, 0), (10, 10), (0, 10),
        (0, 1), (9, 1), (9, 9), (1, 9),
        (1, 2), (8, 2), (8, 8), (2, 8),
...
# Alias for backward compatibility
create_nested_polygon = nested_polygon
...
# Alias for backward compatibility
validate_triangulation = validate
