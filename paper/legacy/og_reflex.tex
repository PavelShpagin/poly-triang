...
Output-sensitive algorithms exist for convex hulls~\cite{kirkpatrick1986} and other geometric problems. Keil~\cite{keil2000} surveys polygon decomposition complexity, though the $O(n + r\log r)$ bound does not appear there. Hertel and Mehlhorn~\cite{hertel1983} and Chazelle and Incerpi~\cite{chazelle1984} study related decomposition problems.

\paragraph{Organization.}
\Cref{sec:prelim} proves the extrema bound. \Cref{sec:algorithm} presents the algorithm. \Cref{sec:correctness} establishes correctness. \Cref{sec:complexity} analyzes complexity. \Cref{sec:discussion} discusses extensions.
