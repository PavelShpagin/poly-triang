...
Experiments show a \textbf{8--10$\times$ speedup on convex polygons} and a \textbf{1.2--1.6$\times$ speedup on star polygons} over the standard Garey et al.\ monotone-decomposition baseline. On large random polygons ($n=10{,}000$), we achieve a \textbf{1.25$\times$ speedup} over Garey et al.\ across our benchmark suite.
\end{abstract}
