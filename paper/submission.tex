...
Experiments show a \textbf{8--10$\times$ speedup on convex polygons} and \textbf{about 20\% faster on star polygons} over the standard Garey et al.\ monotone-decomposition baseline. On large random polygons ($n=10{,}000$), we are \textbf{about 25\% faster} than Garey et al. The key practical advantage is that many real-world polygons are nearly convex or have structured reflex vertices, where our algorithm excels.
\end{abstract}
