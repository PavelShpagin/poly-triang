...
In addition to this necessary sanity check, we include a diagonal-validity checker in the artifact (\texttt{check\_diagonal\_validity.py}) which samples generated polygons and verifies that the decomposition diagonals do not properly intersect the boundary or each other.
The artifact script \texttt{reproduce.sh} runs this check before benchmarking.
