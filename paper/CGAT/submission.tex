...
For convex inputs, our implementation benefits from the linear-time fan fast path and achieves a \textbf{large speedup} over Garey et al.\ in our suite (often tens of $\times$). On dent polygons (very small $k$), we are competitive and often comparable to the monotone-decomposition baseline. On random polygons, our method is competitive and often the fastest for $n \ge 1{,}000$ in our suite, while Garey et al.\ can remain slightly faster at some smaller sizes (and at $n=5{,}000$ in our runs). On star polygons, results are close: we are fastest up to $n=5{,}000$ in our suite, while Garey et al.\ is faster at $n=10{,}000$. Seidel exhibits high constant factors in our experiments.
