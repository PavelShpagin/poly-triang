...
Experiments show a \textbf{6--13$\times$ speedup on convex polygons} over the standard Garey et al.\ monotone-decomposition baseline. On large random polygons ($n=10{,}000$), we achieve \textbf{about a 1.4$\times$ speedup} over Garey et al.; on star polygons, we observe a \textbf{1.2--1.7$\times$ speedup} across the tested range.
\end{abstract}
