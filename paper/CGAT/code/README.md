...
- `--algo chain` runs the chain-based method (no fallback). This is what the benchmark harness uses.
- `--algo chain_only` is an alias of `chain` (kept for backwards compatibility).
