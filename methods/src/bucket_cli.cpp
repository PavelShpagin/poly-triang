/**
 * CLI for Bucket Triangulation Algorithm
 * 
 * Usage: bucket_cli --input polygon.poly --output triangulation.tri
 */
...
#include "bucket_triangulation.hpp"
...
int main(int argc, char* argv[]) {
    ...
    std::vector<bucket::Point> polygon(n);
    for (int i = 0; i < n; i++) {
    ...
    bucket::BucketTriangulator triangulator;
